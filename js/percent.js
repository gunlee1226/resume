$("document").ready(function () {
  ...
  $("#CPP").text(document.getElementById('CPP').style.width)
  $("#JAVA").text(document.getElementById('JAVA').style.width)
  $("#SPRING").text(document.getElementById('SPRING').style.width)
  $("#PYTHON").text(document.getElementById('PYTHON').style.width)
